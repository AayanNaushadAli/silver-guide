...
-- Clear existing 4th sem CS data just in case you run this multiple times
DELETE FROM syllabi WHERE semester = 4 AND branch = 'cs';

-- Intert Operating Systems (BCS401)
INSERT INTO syllabi (branch, semester, subject_code, subject_name, icon, icon_color, units)
VALUES (
    'cs', 4, 'BCS401', 'Operating Systems', 'memory', '#3b82f6',
    '[
        { "name": "Introduction", "topics": "Operating system and functions, Classification of Operating systems (Batch, Interactive, Time sharing, Real Time System, Multiprocessor Systems, Multiuser Systems, Multiprocess Systems, Multithreaded Systems). Operating System Structure (Layered structure, System Components, Operating System services, Reentrant Kernels, Monolithic and Microkernel Systems)." },
...
VALUES (
    ...
    '[
        ...
        { "name": "CYBER CRIME", "topics": "Mobile and Wireless Devices-Introduction, Proliferation of Mobile and Wireless Devices, Trends in Mobility, Credit Card Frauds in Mobile and Wireless Computing Era, Security Challenges Posed by Mobile Devices, Registry Settings for Mobile Devices, Authentication Service Security, Attacks on Mobile/Cell Phones, Mobile Devices: Security Implications for organizations, Organizational Measures for Handling Mobile, Organizational Security Policies and Measures in Mobile Computing Era." },
        { "name": "TOOLS AND METHODS USED IN CYBERCRIME", "topics": "Introduction, Proxy Servers and Anonymizers, Phishing, Password Cracking, Keyloggers and Spywares, Virus and Worms, Trojan-horses and Backdoors, Steganography, DoS and DDoS Attacks, SQL Injection, Buffer Overflow, Attacks on Wireless Networks. Phishing and Identity Theft: Introduction to Phishing, Identity Theft (ID Theft)." },
        { "name": "UNDERSTANDING COMPUTER FORENSICS", "topics": "Introduction, Digital Forensics Science, The Need for Computer Forensics, Cyber forensics and Digital Evidence, Forensics Analysis of E-Mail, Digital Forensics Life Cycle, Chain of Custody Concept, Network Forensics, Approaching a Computer Forensics Investigation. Forensics and Social Networking Sites: The Security/Privacy Threats, Challenges in Computer Forensics." },
        { "name": "INTRODUCTION TO SECURITY POLICIES AND CYBER LAWS", "topics": "Need for An Information Security Policy, Introduction to Indian Cyber Law, Objective and Scope of the Digital Personal Data Protection Act 2023, Intellectual Property Issues, Overview of Intellectual Property Related Legislation in India, Patent, Copyright, Trademarks." }
    ]'::jsonb
);
